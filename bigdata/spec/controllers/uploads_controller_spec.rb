  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved upload as @upload" do
        ...
        post :create, {:upload => { "filename" => "invalid value" }}, valid_session
        expect(assigns(:upload)).to be_a_new(Upload)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested upload" do
        ...
        expect_any_instance_of(Upload).to receive(:update).with({ "filename" => "MyString" })
        put :update, {:id => upload.to_param, :upload => { "filename" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the upload as @upload" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        allow_any_instance_of(Upload).to receive(:save).and_return(false)
        put :update, {:id => upload.to_param, :upload => { "filename" => "invalid value" }}, valid_session
        expect(assigns(:upload)).to eq(upload)
      end

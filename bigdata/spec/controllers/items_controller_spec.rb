  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved item as @item" do
        ...
        post :create, {:item => { "merchant_id" => "invalid value" }}, valid_session
        expect(assigns(:item)).to be_a_new(Item)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested item" do
        ...
        expect_any_instance_of(Item).to receive(:update).with({ "merchant_id" => "1" })
        put :update, {:id => item.to_param, :item => { "merchant_id" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the item as @item" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        allow_any_instance_of(Item).to receive(:save).and_return(false)
        put :update, {:id => item.to_param, :item => { "merchant_id" => "invalid value" }}, valid_session
        expect(assigns(:item)).to eq(item)
      end

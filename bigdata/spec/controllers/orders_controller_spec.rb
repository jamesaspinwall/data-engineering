...
describe OrdersController do
  ...
  let(:valid_attributes) { { "upload_id" => "1" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved order as @order" do
        ...
        post :create, {:order => { "upload_id" => "invalid value" }}, valid_session
        expect(assigns(:order)).to be_a_new(Order)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested order" do
        ...
        expect_any_instance_of(Order).to receive(:update).with({ "upload_id" => "1" })
        put :update, {:id => order.to_param, :order => { "upload_id" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the order as @order" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        allow_any_instance_of(Order).to receive(:save).and_return(false)
        put :update, {:id => order.to_param, :order => { "upload_id" => "invalid value" }}, valid_session
        expect(assigns(:order)).to eq(order)
      end
